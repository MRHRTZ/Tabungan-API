...
from app.core.entities.nasabah import SaveMoney
...
class SaveMoneyUseCase:
    def __init__(self):
        self.nasabah_repository = NasabahRepository()
        self.transaction_repository = TransactionRepository()

    def execute(self, user_data: SaveMoney) -> dict:
        coreSend = {
            'status': 200,
        ...
        self.nasabah_repository.save_money(user_data.no_rekening, user_data.nominal)
        ...
        transactionObj['trx_code'] = 'C'
        transactionObj['amount'] = user_data.nominal
        ...
        coreSend['result'] = {'saldo':saldo_nasabah}
